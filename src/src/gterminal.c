...
GTerminalReceiver* gterminal_create_terminal (GError** error) {
	...
	terminal_client_append_create_instance_options (_tmp3_, _tmp4_, _tmp5_, _tmp6_, _tmp7_, _tmp8_, NULL, _tmp9_, _tmp10_);
	...
	_tmp25_ = _tmp24_;
	_tmp26_ = obj_path;
	_tmp27_ = g_initable_new (GTERMINAL_TYPE_RECEIVER_PROXY, NULL, &_inner_error_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES, "g-name", _tmp25_, "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", _tmp26_, "g-interface-name", "org.gnome.Terminal.Terminal0", NULL);
